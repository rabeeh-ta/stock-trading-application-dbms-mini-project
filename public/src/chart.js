...
!(function (t, e) {
  ...
  function Me(t, e, i, s) {
    ...
    return (
      (void 0 !== e || void 0 !== i) &&
        ...
        l.height &&
        c > l.height &&
        ((c = l.height), (h = ve(Math.floor(c * s)))),
      { width: h, height: c }
    );
  }
  function we(t, e, i) {
    ...
    for (h = 0; h < l; h++)
      if (((u = i[h]), null != u && !0 !== n(u))) r = De(t, o, a, r, u);
        ...
        for (c = 0, d = u.length; c < d; c++)
          (f = u[c]), null == f || n(f) || (r = De(t, o, a, r, f));
    t.restore();
    const g = a.length / 2;
    if (g > i.length) {
          ...
          (function (t, e, i) {
            ...
            n(h) &&
              ...
              (h = (function (t, e, i, s) {
                ...
                if (k(a.index) && s(t)) e = e[a.index % e.length];
                else if (o(e[0])) {
                  const i = e,
  ...
  function $e(t, e = { scriptable: !0, indexable: !0 }) {
    const {
  ...
  function Ge(t, e, i, s, n) {
    for (const o of e) {
      ...
      if (e) {
        ...
        if (k(o) && o !== i && o !== s) return o;
      } else if (!1 === e && k(s) && i !== s) return null;
    }
    return !1;
  }
  function Ze(t, e, i, s) {
    ...
    !(function (t, e, i) {
      ...
      (function (t, e, i = 'x') {
        ...
        let o,
          ...
          l = si(t, 0);
        for (let h = 0; h < n; ++h) {
          if (((a = r), (r = l), (l = si(t, h + 1)), !r)) continue;
          const n = r[i],
            c = r[s];
          a &&
            ((o = (n - a[i]) / 3),
  ...
  const hi = (t) => 0 === t || 1 === t,
    ...
    ui = {
      ...
      easeInElastic: (t) => (hi(t) ? t : ci(t, 0.075, 0.3)),
      easeOutElastic: (t) => (hi(t) ? t : di(t, 0.075, 0.3)),
      easeInOutElastic(t) {
        const e = 0.1125;
        return hi(t)
          ? t
      ...
      easeInOutBounce: (t) =>
        t < 0.5
          ? 0.5 * ui.easeInBounce(2 * t)
          : 0.5 * ui.easeOutBounce(2 * t - 1) + 0.5,
    };
  function fi(t, e, i, s) {
  ...
  function _i(t, e) {
    ...
    for (const t of n) i[t] = +a(t) || 0;
    return i;
  }
  function yi(t) {
    return _i(t, { top: 'y', right: 'x', bottom: 'y', left: 'x' });
  }
  function vi(t) {
      ...
      (m = e[t % a]),
        m.skip ||
          ...
          p !== b &&
            ...
            null !== _ &&
              v() &&
              (g.push(Ti({ start: _, end: t, loop: u, count: a, style: f })),
              (_ = null)),
            (i = t),
            (b = p)));
    return (
      null !== _ &&
        g.push(Ti({ start: _, end: d, loop: u, count: a, style: f })),
      g
    );
  }
  function Ei(t, e) {
  ...
  function Ri(t, e) {
    ...
    if (!0 === s) return Ii(t, [{ start: a, end: r, loop: o }], i, e);
    return Ii(
      t,
      (function (t, e, i, s) {
        const n = t.length,
  ...
  var Yi = {
    ...
    modes: {
      ...
      point: (t, e, i, s) =>
        Wi(t, ye(e, t), i.axis || 'xy', s, i.includeInvisible || !1),
      nearest(t, e, i, s) {
        const n = ye(e, t),
          o = i.axis || 'xy',
          a = i.includeInvisible || !1;
  ...
  function ss(t, e, i, s) {
    ...
    for (const r of t) {
      ...
      if (r.horizontal) {
        ...
        k(l.start) && (a = l.start),
          t.fullSize
            ? is(t, n.left, a, i.outerWidth - n.right - n.left, o)
            : is(t, e.left + l.placed, a, s, o),
          (l.start = a),
          (l.placed += s),
          (a = t.bottom);
      } else {
        ...
        k(l.start) && (o = l.start),
          t.fullSize
            ? is(t, o, n.top, a, i.outerHeight - n.bottom - n.top)
            : is(t, o, e.top + l.placed, a, s),
          (l.start = o),
          (l.placed += s),
          (o = t.right);
      }
  ...
  function us(t, e, i) {
    const s = t.canvas,
      n = new MutationObserver((t) => {
        let e = !1;
        for (const i of t)
          (e = e || ds(i.addedNodes, s)), (e = e && !ds(i.removedNodes, s));
        e && i();
      });
  ...
  function fs(t, e, i) {
    const s = t.canvas,
      n = new MutationObserver((t) => {
        let e = !1;
        for (const i of t)
          (e = e || ds(i.removedNodes, s)), (e = e && !ds(i.addedNodes, s));
        e && i();
      });
    return n.observe(document, { childList: !0, subtree: !0 }), n;
  }
  ...
  function bs(t, e, i) {
    ...
    return (
      a.observe(n),
      (function (t, e) {
        gs.size || window.addEventListener('resize', ms), gs.set(t, e);
      })(t, o),
      a
    );
  }
  function xs(t, e, i) {
    i && i.disconnect(),
      'resize' === e &&
        (function (t) {
          gs.delete(t), gs.size || window.removeEventListener('resize', ms);
        })(t);
  }
  function _s(t, e, i) {
    const s = t.canvas,
  ...
  class ys extends os {
    ...
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        s = i[e];
      if (!s) return;
      (({ attach: xs, detach: xs, resize: xs }[e] || cs)(t, e, s),
        (i[e] = void 0));
    }
    getDevicePixelRatio() {
  ...
  class Vs {
    ...
    buildOrUpdateElements(t) {
      ...
      (e._stacked = As(e.vScale, e)),
        e.stack !== i.stack && ((s = !0), Is(e), (e.stack = i.stack)),
    ...
    applyStack(t, e, i) {
      const s = this.chart,
        ...
        o = e[t.axis];
      return Os(
        { keys: Cs(s, !0), values: e._stacks[t.axis]._visualValues },
        o,
        n.index,
        { mode: i }
      );
    ...
    updateRangeFromParsed(t, e, i, s) {
      ...
      s && a && ((s.values = a), (o = Os(s, n, this._cachedMeta.index))),
    ...
    getMinMax(t, e) {
      const i = this._cachedMeta,
        ...
        l = ((t, e, i) =>
          t && !e.hidden && e._stacked && { keys: Cs(i, !0), values: null })(
          e,
          i,
          this.chart
        ),
    ...
    _resolveElementOptions(t, e = 'default', i) {
      ...
      return (
        f.$shared && ((f.$shared = r), (n[o] = Object.freeze(Fs(f, r)))), f
      );
    }
  ...
  function Ns(t, e) {
    ...
    if (r > 0) {
      ...
      for (Ws(e, c, d, s(n) ? 0 : l - n, l), t = 0, i = r - 1; t < i; t++)
        Ws(e, c, d, a[t], a[t + 1]);
      return Ws(e, c, d, h, s(n) ? e.length : h + n), c;
    }
    return Ws(e, c, d), c;
  }
  ...
  class qs extends Bs {
    ...
    update(t, e, i) {
      ...
      this._convertTicksToLabels(r ? js(this.ticks, a) : this.ticks),
        this.configure(),
    ...
    fit() {
      const t = { width: 0, height: 0 },
        ...
        a = this.isHorizontal();
      if (o) {
        const o = Us(s, e.options.font);
        if (
          (a
            ? ((t.width = this.maxWidth), (t.height = Ys(n) + o))
            : ((t.height = this.maxHeight), (t.width = Ys(n) + o)),
        ...
        if (
          ...
          if (n(d))
            for (h = 0, c = d.length; h < c; ++h)
              (_ = d[h]),
                s(_) || n(_) || ((b = De(i, p.data, p.gc, b, _)), (x += m));
        } else (b = De(i, p.data, p.gc, b, d)), (x = m);
      ...
      if (t >= 0 && t < e.length) {
        ...
        return (
          ...
          (i.$context = (function (t, e, i) {
            return Pi(t, { tick: i, index: e, type: 'tick' });
          })(this.getContext(), t, i))
        );
      }
      return (
    ...
    _layers() {
      ...
      return this._isVisible() && this.draw === qs.prototype.draw
        ? [
            {
              z: i,
              draw: (t) => {
  ...
  class Gs {
    constructor() {
      (this.controllers = new Ks(Vs, 'datasets', !0)),
        (this.elements = new Ks(Bs, 'elements')),
        (this.plugins = new Ks(Object, 'plugins')),
        (this.scales = new Ks(qs, 'scales')),
    ...
    _createDescriptors(t, e) {
      const i = t && t.config,
        ...
        n = (function (t) {
          const e = {},
            i = [],
            s = Object.keys(Zs.plugins.items);
          for (let t = 0; t < s.length; t++) i.push(Zs.getPlugin(s[t]));
          const n = t.plugins || [];
        ...
        ? (function (t, { plugins: e, localIds: i }, s, n) {
            ...
            for (const r of e) {
              ...
              null !== l &&
                o.push({
                  plugin: r,
                  options: tn(t.config, { plugin: r, local: i[e] }, l, a),
                });
            }
            return o;
          })(t, n, s, e)
  ...
  function tn(t, { plugin: e, local: i }, s, n) {
    ...
    if (
      (t =
        ...
        ('top' === (i = e.position) || 'bottom' === i
          ...
          ? 'y'
          : void 0) ||
        (t.length > 1 && sn(t[0].toLowerCase(), e)))
    )
      return t;
    throw new Error(
        ...
        return (
          Object.keys(s).forEach((t) => {
            ...
            const r = sn(t, e),
              ...
              h = i.scales || {};
            a[t] = x(Object.create(null), [{ axis: r }, e, h[r], h[l]]);
          }),
  ...
  function ln(t, e) {
    let i = an.get(t);
    return i || ((i = e()), an.set(t, i), rn.add(i)), i;
  }
  const hn = (t, e, i) => {
    const s = M(e, i);
    void 0 !== s && t.add(s);
  ...
  class cn {
    constructor(t) {
      (this._config = (function (t) {
        return ((t = t || {}).data = on(t.data)), nn(t), t;
      })(t)),
    ...
    getOptionScopes(t, e, i) {
      ...
      e.forEach((e) => {
        t && (r.add(t), e.forEach((e) => hn(r, t, e))),
          e.forEach((t) => hn(r, s, t)),
          e.forEach((t) => hn(r, re[n] || {}, t)),
          e.forEach((t) => hn(r, ue, t)),
          e.forEach((t) => hn(r, le, t));
      });
    ...
    resolveNamedOptions(t, e, i, s = ['']) {
      const o = { $shared: !0 },
        { resolver: a, subPrefixes: r } = dn(this._resolverCache, t, s);
      let l = a;
      if (
        (function (t, e) {
    ...
    createResolver(t, e, i = [''], s) {
      const { resolver: n } = dn(this._resolverCache, t, i);
  ...
  class Mn {
    ...
    constructor(t, e) {
      ...
      (this.id = i()),
        ...
        (_n[this.id] = this),
        r && l
          ? (xt.listen(this, 'complete', mn),
            xt.listen(this, 'progress', bn),
            this._initialize(),
      ...
      e &&
        ...
        u(n, (e) => {
          const n = e.options,
            ...
            a = sn(o, n),
            r = l(n.type, e.dtype);
          (void 0 !== n.position && gn(n.position, a) === gn(e.dposition)) ||
    ...
    buildOrUpdateControllers() {
      ...
      for (
        ...
        if (
          ...
          (n.type = o),
          (n.indexAxis = s.indexAxis || en(o, this.options)),
          (n.order = s.order || 0),
          (n.index = i),
          (n.label = '' + s.label),
  ...
  function Rn(t, { inflateAmount: e }, i) {
  ...
  var Fn = Object.freeze({
        ...
        for (let f = e; f < e + i; f++) {
          const e = this.getParsed(f),
            ...
            m = {
              ...
              base: i.base,
              enableBorderRadius:
                !p || An(e._custom) || a === p._top || a === p._bottom,
              x: h ? i.head : g.center,
              y: h ? g.center : i.head,
    ...
    PieController: class extends In {
      static id = 'pie';
      static defaults = {
        cutout: 0,
        rotation: 0,
  ...
  function Vn(t, e, i, s) {
    const n = _i(t.options.borderRadius, [
      'outerStart',
      'outerEnd',
      'innerStart',
      'innerEnd',
  ...
  function Yn(t, e, i, s) {
    const { points: n, options: o } = e,
      { count: a, start: r, loop: l, ilen: h } = $n(n, i, s),
      c = (function (t) {
        return t.stepped
          ? ze
  ...
  class Gn extends Bs {
    ...
    interpolate(t, e) {
      const i = this.options,
        s = t[e],
        n = this.points,
        o = Ei(this, { property: e, start: s, end: s });
      if (!o.length) return;
      const a = [],
        r = (function (t) {
          return t.stepped
    ...
    draw(t, e, i, s) {
      ...
      (this.points || []).length &&
        n.borderWidth &&
        (t.save(), Kn(t, this, i, s), t.restore()),
    ...
    const e = Jn(t),
      ...
      n = (function (t, e, i) {
        const s = t.options.borderWidth,
          ...
          o = yi(s);
        return {
          t: Qn(n.top, o.top, 0, i),
          r: Qn(n.right, o.right, 0, e),
          b: Qn(n.bottom, o.bottom, 0, i),
          l: Qn(n.left, o.left, 0, e),
        };
      })(t, i / 2, s / 2),
      a = (function (t, e, i) {
        const { enableBorderRadius: s } = t.getProps(['enableBorderRadius']),
          ...
          h = s || o(n);
        return {
          topLeft: Qn(!h || l.top || l.left, a.topLeft, 0, r),
          topRight: Qn(!h || l.top || l.right, a.topRight, 0, r),
          bottomLeft: Qn(!h || l.bottom || l.left, a.bottomLeft, 0, r),
          bottomRight: Qn(!h || l.bottom || l.right, a.bottomRight, 0, r),
        };
      })(t, i / 2, s / 2);
    return {
  ...
  function ro(t, e, { horizontal: i, minRotation: s }) {
    const n = $(s),
      ...
      const n = (function (t, e) {
        ...
        for (
          ...
          (u && M !== a
            ? (i.push({ value: a }),
              M < a && D++,
              V(Math.round((M + D * S) * v) / v, a, ro(a, y, t)) && D++)
            : M < a && D++);
          D < k;
          ++D
        )
          i.push({ value: Math.round((M + D * S) * v) / v });
        return (
          x && u && w !== r
            ? i.length && V(i[i.length - 1].value, r, ro(r, y, t))
  ...
  const co = (t) => Math.floor(z(t)),
    uo = (t, e) => Math.pow(10, co(t) + e);
  function fo(t) {
    return 1 === t / Math.pow(10, co(t));
  }
  function go(t, e, i) {
  ...
  function po(t, { min: e, max: i }) {
    ...
    for (; f < i; )
      s.push({ value: f, major: fo(f), significand: u }),
        u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
        u >= 20 && (o++, (u = 2), (a = o >= 0 ? 1 : a)),
        (f = Math.round((h + d + u * Math.pow(10, o)) * a) / a);
    const g = r(t.max, f);
    return s.push({ value: g, major: fo(g), significand: u }), s;
  }
  class mo extends qs {
    ...
    parse(t, e) {
      const i = lo.prototype.parse.apply(this, [t, e]);
    ...
    determineDataLimits() {
      ...
      (this.min = a(t) ? Math.max(0, t) : null),
        ...
        this._zero &&
          ...
          !a(this._userMin) &&
          (this.min =
            t === uo(this.min, 0) ? uo(this.min, -1) : uo(this.min, 0)),
        this.handleTickRangeOptions();
    }
    handleTickRangeOptions() {
      ...
      const n = (e) => (i = t ? i : e),
        o = (t) => (s = e ? s : t);
      i === s && (i <= 0 ? (n(1), o(10)) : (n(uo(i, -1)), o(uo(s, 1)))),
        i <= 0 && n(uo(s, -1)),
        s <= 0 && o(uo(i, 1)),
        (this.min = i),
        (this.max = s);
    ...
    buildTicks() {
      const t = this.options,
        e = po({ min: this._userMin, max: this._userMax }, this);
      return (
    ...
    for (let u = 0; u < a; u++) {
      ...
      const f = t.getPointPosition(u, t.drawingArea + o[u], l),
        ...
        p =
          ...
          { w: Ce(h, c.string, d), h: d.length * c.lineHeight });
      s[u] = p;
      const m = G(t.getIndexAngle(u) + l),
        b = Math.round(Y(m));
      yo(i, e, m, xo(b, f.x, p.w, 0, 180), xo(b, f.y, p.h, 90, 270));
    }
    var h, c, d;
  ...
  class So extends lo {
    ...
    setDimensions() {
      const t = (this._padding = Mi(bo(this.options) / 2)),
    ...
    generateTickLabels(t) {
      lo.prototype.generateTickLabels.call(this, t),
    ...
    getPointLabelContext(t) {
      ...
      if (t >= 0 && t < e.length) {
        ...
        return (function (t, e, i) {
          return Pi(t, { label: i, index: e, type: 'pointLabel' });
        })(this.getContext(), t, i);
      }
    }
    ...
    drawLabels() {
      ...
      t.save(),
        ...
        this.ticks.forEach((s, a) => {
          ...
          Ve(t, s.label, 0, -n, l, { color: r.color });
        }),
        t.restore();
    }
    drawTitle() {}
  ...
  function Ao(t, e, i, s) {
    const n = Do.length;
    for (let o = Do.indexOf(t); o < n - 1; ++o) {
      const t = Po[Do[o]],
        n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
      if (t.common && Math.ceil((i - e) / (n * t.size)) <= s) return Do[o];
    }
    return Do[n - 1];
  }
  function To(t, e, i) {
  ...
  class Eo extends qs {
    ...
    buildTicks() {
      ...
      return (
        (this._unit =
          e.unit ||
          (i.autoSkip
            ? Ao(e.minUnit, this.min, this.max, this._getLabelCapacity(n))
            : (function (t, e, i, s, n) {
                for (let o = Do.length - 1; o >= Do.indexOf(i); o--) {
                  const i = Do[o];
                  if (Po[i].common && t._adapter.diff(n, s, i) >= e - 1)
                    return i;
                }
                return Do[i ? Do.indexOf(i) : 0];
              })(this, o.length, e.minUnit, this.min, this.max))),
        (this._majorUnit =
          i.major.enabled && 'year' !== this._unit
            ? (function (t) {
                for (let e = Do.indexOf(t) + 1, i = Do.length; e < i; ++e)
                  if (Po[Do[e]].common) return Do[e];
              })(this._unit)
            : void 0),
        this.initOffsets(s),
        t.reverse && o.reverse(),
        Lo(this, o, this._majorUnit)
      );
    }
    afterAutoSkip() {
    ...
    _generate() {
      ...
      for (d = f, u = 0; d < i; d = +t.add(d, a, o), u++) To(c, d, g);
      return (
        (d !== i && 'ticks' !== s.bounds && 1 !== u) || To(c, d, g),
        Object.keys(c)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    getLabelTimestamps() {
      ...
      for (e = 0, i = s.length; e < i; ++e) t.push(Oo(this, s[e]));
  ...
  var Io = Object.freeze({
    __proto__: null,
    CategoryScale: class extends qs {
      static id = 'category';
      ...
      parse(t, e) {
        ...
        return ((t, e) => (null === t ? null : J(Math.round(t), 0, e)))(
          (e =
            isFinite(e) && i[e] === t
              ? e
              : oo(i, t, l(e, t), this._addedLabels)),
          i.length - 1
        );
      }
      determineDataLimits() {
    ...
    TimeScale: Eo,
    TimeSeriesScale: class extends Eo {
      ...
      initOffsets() {
        ...
        (this._minPos = Ro(e, this.min)),
          (this._tableRange = Ro(e, this.max) - this._minPos),
          super.initOffsets(t);
      }
      buildLookupTable(t) {
  ...
  function No(t) {
    ...
    return (i, s) => {
      ...
      n instanceof In
        ? (e = (function (t, e) {
            return (t.backgroundColor = t.data.map(() => Vo(e++))), e;
          })(i, e))
        : n instanceof zn
        ? (e = (function (t, e) {
        ...
        : n &&
          (e = (function (t, e) {
            return (t.borderColor = Vo(e)), (t.backgroundColor = Bo(e)), ++e;
          })(i, e));
    };
  }
  function Wo(t) {
  ...
  var Ho = {
    ...
    beforeLayout(t, e, i) {
      ...
      if (!i.forceOverride && (Wo(n) || (s && Wo(s)))) return;
      const o = No(t);
      n.forEach(o);
    },
  };
  ...
  var Yo = {
    ...
    beforeElementsUpdate: (t, e, i) => {
      if (!i.enabled) return void $o(t);
      const n = t.width;
      t.data.datasets.forEach((e, o) => {
        const { _data: a, indexAxis: r } = e,
          l = t.getDatasetMeta(o),
          h = a || e.data;
        if ('y' === ki([r, t.options.indexAxis])) return;
        ...
        if (u <= (i.threshold || 4 * n)) return void jo(e);
        let f;
        switch (
          (s(a) &&
            ((e._data = h),
  ...
  function Ko(t, e) {
    ...
    return (
      ...
      i.length
        ? new Gn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
        : null
    );
  }
  function Go(t) {
  ...
  function Qo(t, e, i) {
    ...
    for (let n = 0; n < i.length; n++) {
      const o = i[n],
        { first: a, last: r, point: l } = ta(o, e, 'x');
      if (!(!l || (a && r)))
        if (a) s.unshift(l);
  ...
  function ia(t) {
    ...
    if ('stack' === i)
      return (function (t) {
        ...
        r.push(Ko({ x: null, y: e.bottom }, s));
        for (let t = 0; t < o.length; t++) {
          const e = o[t];
          for (let t = e.start; t <= e.end; t++) Qo(n, a[t], r);
        }
        return new Gn({ points: n, options: {} });
      })(t);
    if ('shape' === i) return !0;
    const n = (function (t) {
    ...
    return n instanceof ea ? n : Ko(n, s);
  }
  function sa(t, e, i) {
    const s = ia(e),
      ...
      (function (t, e) {
        ...
        t.save(),
          'x' === l &&
            o !== n &&
            (na(t, s, a.top),
            oa(t, { line: i, target: s, color: n, scale: r, property: l }),
            t.restore(),
            t.save(),
            na(t, s, a.bottom));
        oa(t, { line: i, target: s, color: o, scale: r, property: l }),
          t.restore();
      })(t, {
        line: n,
        target: s,
  ...
  function oa(t, e) {
    const { line: i, target: s, property: n, color: o, scale: a } = e,
      r = (function (t, e, i) {
        ...
        for (const t of s) {
          ...
          const h = Ei(e, l);
          for (const e of h) {
            const s = Uo(i, o[e.start], o[e.end], e.loop),
              r = Li(t, n, s);
            for (const t of r)
              a.push({
                source: t,
    ...
    for (const { source: e, target: l, start: h, end: c } of r) {
      const { style: { backgroundColor: r = o } = {} } = e,
        d = !0 !== s;
      t.save(), (t.fillStyle = r), aa(t, a, d && Uo(n, h, c)), t.beginPath();
      const u = !!i.pathSegment(t, e);
      let f;
      if (d) {
        u ? t.closePath() : ra(t, s, c, n);
  ...
  var la = {
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (a = 0; a < s; ++a)
        (o = t.getDatasetMeta(a)),
          ...
          n.push(l);
      for (a = 0; a < s; ++a)
        (l = n[a]), l && !1 !== l.fill && (l.fill = Zo(n, a, i.propagate));
    },
    beforeDraw(t, e, i) {
    ...
    beforeDatasetsDraw(t, e, i) {
      ...
      for (let e = s.length - 1; e >= 0; --e) {
        const i = s[e].$filler;
        Go(i) && sa(t.ctx, i, t.chartArea);
      }
    },
    beforeDatasetDraw(t, e, i) {
      const s = e.meta.$filler;
      Go(s) && 'beforeDatasetDraw' === i.drawTime && sa(t.ctx, s, t.chartArea);
    },
  ...
  class ca extends Bs {
    ...
    fit() {
      ...
      const i = t.labels,
        ...
        { boxWidth: a, itemHeight: r } = ha(i, n);
      let l, h;
      (e.font = s.string),
        this.isHorizontal()
    ...
    _draw() {
      ...
      this.drawTitle(),
        ...
        (s.lineWidth = 0.5),
        (s.font = h.string);
      const { boxWidth: g, boxHeight: p, itemHeight: m } = ha(o, d),
        b = this.isHorizontal(),
  ...
  var ua = {
    ...
    _element: ca,
    start(t, e, i) {
      const s = (t.legend = new ca({ ctx: t.ctx, options: i, chart: t }));
      ns.configure(t, s, i), ns.addBox(t, s);
    },
    stop(t) {
    ...
    beforeUpdate(t, e, i) {
      const s = t.legend;
      ns.configure(t, s, i), (s.options = i);
    },
    afterUpdate(t) {
      const e = t.legend;
  ...
  var ga = {
    ...
    start(t, e, i) {
      !(function (t, e) {
        const i = new fa({ ctx: t.ctx, options: e, chart: t });
  ...
  var ma = {
    id: 'subtitle',
    start(t, e, i) {
      const s = new fa({ ctx: t.ctx, options: i, chart: t });
      ns.configure(t, s, i), ns.addBox(t, s), pa.set(t, s);
    },
    stop(t) {
      ns.removeBox(t, pa.get(t)), pa.delete(t);
    },
    beforeUpdate(t, e, i) {
      const s = pa.get(t);
      ns.configure(t, s, i), (s.options = i);
  ...
  function wa(t, e, i) {
    ...
    return { xAlign: i.xAlign || e.xAlign || Ma(t, e, i, s), yAlign: s };
  }
  function ka(t, e, i, s) {
  ...
  function Oa(t, e, i, s) {
    ...
    return void 0 === n ? Ca[e].call(i, s) : n;
  }
  class Aa extends Bs {
    static positioners = ba;
    constructor(t) {
      super(),
        (this.opacity = 0),
        (this._active = []),
    ...
    getContext() {
      return (
        ...
        (this.$context =
          ...
          Pi(t, { tooltip: e, tooltipItems: i, type: 'tooltip' })))
      );
      var t, e, i;
    }
    getTitle(t, e) {
      const { callbacks: i } = e,
        s = Oa(i, 'beforeTitle', this, t),
        n = Oa(i, 'title', this, t),
        o = Oa(i, 'afterTitle', this, t);
      let a = [];
      return (a = xa(a, _a(s))), (a = xa(a, _a(n))), (a = xa(a, _a(o))), a;
    }
    getBeforeBody(t, e) {
      return Pa(Oa(e.callbacks, 'beforeBody', this, t));
    }
    getBody(t, e) {
      const { callbacks: i } = e,
        s = [];
      return (
        u(t, (t) => {
          const e = { before: [], lines: [], after: [] },
            n = Da(i, t);
          xa(e.before, _a(Oa(n, 'beforeLabel', this, t))),
            xa(e.lines, Oa(n, 'label', this, t)),
            xa(e.after, _a(Oa(n, 'afterLabel', this, t))),
            s.push(e);
        }),
        s
      );
    ...
    getAfterBody(t, e) {
      return Pa(Oa(e.callbacks, 'afterBody', this, t));
    }
    getFooter(t, e) {
      const { callbacks: i } = e,
        s = Oa(i, 'beforeFooter', this, t),
        n = Oa(i, 'footer', this, t),
        o = Oa(i, 'afterFooter', this, t);
      let a = [];
      return (a = xa(a, _a(s))), (a = xa(a, _a(n))), (a = xa(a, _a(o))), a;
    }
    _createItems(t) {
      ...
      let a,
        r,
        l = [];
      for (a = 0, r = e.length; a < r; ++a) l.push(ya(this.chart, e[a]));
      return (
        t.filter && (l = l.filter((e, s, n) => t.filter(e, s, n, i))),
        t.itemSort && (l = l.sort((e, s) => t.itemSort(e, s, i))),
        u(l, (e) => {
          const i = Da(t.callbacks, e);
          s.push(Oa(i, 'labelColor', this, e)),
            n.push(Oa(i, 'labelPointStyle', this, e)),
            o.push(Oa(i, 'labelTextColor', this, e));
        }),
        (this.labelColors = s),
    ...
    update(t, e) {
      ...
      let n,
        o = [];
      if (s.length) {
        const t = ba[i.position].call(this, s, this._eventPosition);
    ...
    _drawColorBox(t, e, i, s, n) {
      ...
      if (n.usePointStyle) {
        ...
        Object.values(r).some((t) => 0 !== t)
          ? (t.beginPath(),
            (t.fillStyle = n.multiKeyBackground),
            We(t, { x: e, y: p, w: h, h: l, radius: r }),
            t.fill(),
            t.stroke(),
            (t.fillStyle = a.backgroundColor),
            t.beginPath(),
            We(t, { x: i, y: p + 1, w: h - 2, h: l - 2, radius: r }),
            t.fill())
          : ((t.fillStyle = n.multiKeyBackground),
            t.fillRect(e, p, h, l),
    ...
    _updateAnimationTarget(t) {
      const e = this.chart,
        ...
        n = i && i.y;
      if (s || n) {
        const i = ba[t.position].call(this, this._active, this._eventPosition);
        if (!i) return;
        const o = (this._size = va(this, t)),
  ...
  var Ta = {
    ...
    positioners: ba,
    afterInit(t, e, i) {
      i && (t.tooltip = new Aa({ chart: t, options: i }));
    },
    beforeUpdate(t, e, i) {
  ...
  return (
    Mn.register(Fn, Io, no, t),
    (Mn.helpers = { ...Vi }),
    (Mn._adapters = Pn),
    (Mn.Animation = Ss),
    (Mn.Animations = Ps),
    (Mn.animator = xt),
    (Mn.controllers = Zs.controllers.items),
    (Mn.DatasetController = Vs),
    (Mn.Element = Bs),
    (Mn.elements = no),
    (Mn.Interaction = Yi),
    (Mn.layouts = ns),
    ...
    (Mn.Scale = qs),
    (Mn.Ticks = ae),
    Object.assign(Mn, Fn, Io, no, t, Ms),
    (Mn.Chart = Mn),
    'undefined' != typeof window && (window.Chart = Mn),
    Mn
  );
});
